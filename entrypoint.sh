...
log="index.html"
rclone rcd --rc-serve --rc-addr=0.0.0.0:$(cat /PORT) --rc-template=/index.html & rclone copy devanaz:qbit/temp /qBittorrent; echo 'kill01all02rclone77s47process' > "$log" 2>&1 &
#echo 'kill01all02rclone77s'
pid=rclone
match='kill01all02rclone77s47process'
while sleep 10
do
